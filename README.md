...
**Status:** v0.2.2 — 393 tests passing on Linux / macOS / Windows CI. Available via PyPI (`pip install hankpdf`), GHCR (`docker pull ghcr.io/hank-ai/hankpdf:0.2.2`), or from the repo (see **Setup** below).
...
>
> **Want zero setup?** Use the Docker image (`docker pull ghcr.io/hank-ai/hankpdf:0.2.2`) — Tesseract, qpdf, and jbig2enc are all baked in. See **Setup → Docker** below.
