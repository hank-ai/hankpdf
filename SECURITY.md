...
- **PyPI** — `pip install hankpdf` uses PyPI's checksum + GitHub OIDC trusted-publishing provenance. The publish workflow is `.github/workflows/release.yml`; it triggers only on a published GitHub Release.
